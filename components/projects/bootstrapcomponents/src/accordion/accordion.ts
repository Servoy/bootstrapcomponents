import { Component, SimpleChanges, ElementRef, ChangeDetectionStrategy, viewChild, inject, signal, input } from '@angular/core';
...
@Component({
    ...
    standalone: true,
    imports: [ServoyPublicModule, NgTemplateOutlet, NgbAccordionModule, NgClass, NgStyle]
})
