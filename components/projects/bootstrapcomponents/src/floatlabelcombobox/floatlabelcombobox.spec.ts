...
describe('ServoyFloatLabelBootstrapCombobox', () => {
    ...
    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [ServoyPublicTestingModule, FormsModule, NgbDropdown, NgbDropdownItem, NgbTooltip, ServoyFloatLabelBootstrapCombobox],
    ...
    describe('errorShow two-way binding', () => {
        it('should reflect a server-set errorShow value in the rendered error text', async () => {
            ...
            expect(fixture.nativeElement.querySelector('.bts-floatlabelcombobox-error-text')).toBeNull();

            fixture.componentRef.setInput('errorShow', true);
            fixture.detectChanges();
            await fixture.whenStable();

            const errorEl = fixture.nativeElement.querySelector('.bts-floatlabelcombobox-error-text');
        ...
        it('should hide the error text when a server-set errorShow becomes false', async () => {
            ...
            expect(fixture.nativeElement.querySelector('.bts-floatlabelcombobox-error-text')).not.toBeNull();
