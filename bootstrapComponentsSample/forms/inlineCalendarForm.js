...
function onToggleVisible(event) {
	...
	elements.baseInlineCalendar.visible = !elements.baseInlineCalendar.visible 
	// Update status display
	updateBaseCalendarStatus('Calendar visible = ' + elements.baseInlineCalendar.visible);
...
function onToggleEnabled(event) {
	elements.baseInlineCalendar.enabled = !elements.baseInlineCalendar.enabled;
	updateBaseCalendarStatus("Calendar enabled: " + elements.baseInlineCalendar.enabled);
