...
- [ ] `npx ng build @servoy/bootstrapcomponents` compiles without errors
- [ ] `npx ng lint` passes without blocking issues

**Style & conventions**
- [ ] Signal-based inputs/outputs used (not legacy decorators)
- [ ] Component extends proper base class from hierarchy (`ServoyBootstrapBaseLabel`,
      `ServoyBootstrapBasefield`, or `ServoyBootstrapBaseTabPanel`)
- [ ] Selector uses `bootstrapcomponents-` prefix
- [ ] No unused imports
...
- [ ] `servoybootstrap.module.ts` updated if new declarations
